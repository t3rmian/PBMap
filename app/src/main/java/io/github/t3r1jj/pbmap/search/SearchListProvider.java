...
public class SearchListProvider extends SearchRecentSuggestionsProvider {
    ...
    String[] tableColumns = new String[]{
            ...
            SuggestionsDBHelper.SUGGESTIONS_COLUMN_NAME,
            SuggestionsDBHelper.SUGGESTIONS_COLUMN_MAP_PATH
    };
    String whereClause = "lower(" + SuggestionsDBHelper.SUGGESTIONS_COLUMN_NAME + ") LIKE ?";
    String orderBy = SuggestionsDBHelper.SUGGESTIONS_COLUMN_NAME;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        if (selectionArgs != null && selectionArgs.length > 0 && selectionArgs[0].length() > 0) {
            if (db == null) {
                db = new SuggestionsDBHelper(getContext());
            }
            selectionArgs[0] = "%" + selectionArgs[0].toLowerCase() + "%";
