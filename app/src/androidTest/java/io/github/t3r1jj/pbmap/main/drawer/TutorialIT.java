...
public class TutorialIT {
    ...
    public void testTutorial() {
        ...
        onView(withIndex(withText(R.string.help), 1)).perform(click());
        ...
        onView(withId(R.id.level_fab_menu)).perform(click());
        ...
        onView(withId(R.id.more_fab_menu)).perform(click());
        ...
        onView(withId(R.id.content_main)).perform(click());
